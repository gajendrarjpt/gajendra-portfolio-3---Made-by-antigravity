...
export default function SlyNav({ onOpenTerminal, onOpenBridge }) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-display font-bold text-base tracking-wider uppercase text-[#121212] dark:text-white group-hover:text-[#0052FF] dark:group-hover:text-[#00FF66] transition-colors">
                GAJENDRA
              </span>
              <span className="font-mono text-[9px] text-[#5A5A57] dark:text-[#888888] tracking-widest uppercase">
          ...
          {/* Desktop Nav Links */}
          <nav className="absolute left-1/2 -translate-x-1/2 hidden lg:flex items-center gap-7 font-mono text-xs font-semibold tracking-widest uppercase">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-[#5A5A57] dark:text-[#888888] hover:text-[#121212] dark:hover:text-white transition-colors duration-200 relative py-1 group"
              >
                {link.label}
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <button
              ...
              className="font-mono text-xs font-bold tracking-wider uppercase px-4 py-2 border border-[#121212]/30 dark:border-[#2A2A2A] hover:border-[#121212] dark:hover:border-white bg-[#F4F1EA] dark:bg-[#111111] text-[#121212] dark:text-white transition-all flex items-center gap-2 cursor-pointer pointer-events-auto"
            ...
            <button
              ...
              className="font-mono text-[10px] font-bold px-3 py-2 bg-[#121212] dark:bg-[#111111] hover:bg-[#0052FF] text-white border border-[#121212] dark:border-[#2A2A2A] uppercase tracking-wider transition-all cursor-pointer pointer-events-auto"
            >
              CTRL+K TERMINAL
            </button>
            ...
            <button
              ...
              className="font-mono text-xs font-bold px-4 py-2 bg-[#0052FF] hover:bg-[#0042D0] text-white uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-lg shadow-[#0052FF]/20 cursor-pointer pointer-events-auto"
            >
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`fixed inset-0 z-30 bg-[#FAF8F5] dark:bg-[#000000] flex flex-col justify-between p-8 lg:hidden transition-all duration-500 ${
