...
export default function BrandedLoader({ onComplete }) {
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-[#FAF8F5] dark:bg-[#000000] text-[#121212] dark:text-white flex flex-col justify-between p-8 md:p-12 transition-opacity duration-300 pointer-events-none ${isExiting ? 'opacity-0' : 'opacity-100'}`}>
      {/* Header Info */}
