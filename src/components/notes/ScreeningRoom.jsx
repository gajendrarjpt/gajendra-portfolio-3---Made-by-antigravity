...
export default function ScreeningRoom() {
  return (
    <section id="screening-room" className="py-24 md:py-36 border-b border-[#121212]/10 dark:border-[#1F1F1F] bg-[#FAF8F5] dark:bg-[#000000] text-[#121212] dark:text-white relative overflow-hidden transition-colors">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="font-mono text-xs text-[#5A5A57] dark:text-[#888888] uppercase tracking-wider flex items-center gap-2">
        ...
        <div className="flex gap-6 overflow-x-auto pb-8 pt-2 scrollbar-none snap-x snap-mandatory">
          ...
          {featuredProjects.map((proj) => (
            <div
              key={proj.id}
              className="snap-start shrink-0 w-[290px] sm:w-[440px] md:w-[540px] max-w-[85vw] border border-[#121212]/15 dark:border-[#1F1F1F] bg-[#F4F1EA] dark:bg-[#0A0A0A] p-6 sm:p-8 md:p-10 flex flex-col justify-between hover:border-[#0052FF] transition-all group"
            >
              ...
              <div className="pt-8 mt-6 border-t border-[#121212]/10 dark:border-[#1F1F1F] flex items-center justify-between font-mono text-xs">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#5A5A57] dark:text-[#888888] uppercase hover:text-[#121212] dark:hover:text-white"
                >
                  GITHUB ↗
                </a>
              </div>
          ...
          {engineeringNotes.map((note) => (
            <div
              key={note.id}
              className="snap-start shrink-0 w-[280px] sm:w-[380px] md:w-[450px] max-w-[85vw] border border-[#121212]/15 dark:border-[#1F1F1F] bg-[#F4F1EA] dark:bg-[#0A0A0A] p-6 sm:p-8 flex flex-col justify-between hover:border-[#121212] dark:hover:border-white transition-all group"
            >
              <div className="flex flex-col gap-6">
